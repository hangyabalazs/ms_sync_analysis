...
extern Memb_func* memb_func;
 ...
 "setdata_kd_new", _hoc_setdata,
 "ainfi_kd_new", _hoc_ainfi,
 "binfi_kd_new", _hoc_binfi,
 0, 0
};
#define ainfi ainfi_kd_new
#define binfi binfi_kd_new
 extern double ainfi( _threadargsprotocomma_ double );
 extern double binfi( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define sigma_b sigma_b_kd_new
 double sigma_b = -6;
#define sigma_a sigma_a_kd_new
 double sigma_a = 20;
#define theta_b theta_b_kd_new
 double theta_b = -70;
#define theta_a theta_a_kd_new
 double theta_a = -50;
 ...
 "theta_a_kd_new", &theta_a_kd_new,
 "sigma_a_kd_new", &sigma_a_kd_new,
 "theta_b_kd_new", &theta_b_kd_new,
 "sigma_b_kd_new", &sigma_b_kd_new,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 4);
 	...
 	ivoc_help("help ?1 kd_new C:/Users/kocsis.barnabas/Documents/networkmodel/Golomb/modified_Golom_characteristic/version_17nov17/kd_new.mod\n");
