...
#define alpha alpha_fvpre
 double alpha = 1.1;
#define beta beta_fvpre
 double beta = 0.19;
#define e e_fvpre
 double e = 0;
#define thetasyn thetasyn_fvpre
 double thetasyn = 2;
 ...
 "alpha_fvpre", &alpha_fvpre,
 "beta_fvpre", &beta_fvpre,
 "e_fvpre", &e_fvpre,
 "thetasyn_fvpre", &thetasyn_fvpre,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _fvpre_glutamaterg_ongaba_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 4);
 	...
 	ivoc_help("help ?1 fvpre C:/Users/kocsis.barnabas/Desktop/modelling/Neuron_software/ping-pong modell/fvpre_glutamaterg_ongaba.mod\n");
...
double F (  double _lv1 ) {
   double _lF;
 _lF = 1.0 / ( 1.0 + exp ( - ( _lv1 - thetasyn ) / 5.0 ) ) ;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 39 in file fvpre_glutamaterg_ongaba.mod:\n  SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
