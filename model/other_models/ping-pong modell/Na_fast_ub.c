...
extern Memb_func* memb_func;
 ...
 "setdata_Na_fast_ub", _hoc_setdata,
 "rates_Na_fast_ub", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Na_fast_ub
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Na_fast_ub", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Na_fast_ub", "S/cm2",
 "gion_Na_fast_ub", "S/cm2",
 "Xtau_Na_fast_ub", "ms",
 "Ytau_Na_fast_ub", "ms",
 0,0
};
 ...
 "usetable_Na_fast_ub", &usetable_Na_fast_ub,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 Na_fast_ub C:/Users/kocsis.barnabas/Desktop/modelling/Neuron_software/ping-pong modell/Na_fast_ub.mod\n");
...
static int _reset;
static char *modelname = "Channel: Na_fast_ub";
