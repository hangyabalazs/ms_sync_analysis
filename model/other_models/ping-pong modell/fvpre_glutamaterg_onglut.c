...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _fvpre_glutamaterg_onglut_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 4);
 	...
 	ivoc_help("help ?1 fvpre C:/Users/kocsis.barnabas/Desktop/modelling/Neuron_software/ping-pong modell/fvpre_glutamaterg_onglut.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 39 in file fvpre_glutamaterg_onglut.mod:\n  SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
