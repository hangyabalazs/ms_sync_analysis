...
extern Memb_func* memb_func;
 ...
 "setdata_K_cluster_ub", _hoc_setdata,
 "rates_K_cluster_ub", _hoc_rates,
 0, 0
};
...
#define usetable usetable_K_cluster_ub
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_K_cluster_ub", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_K_cluster_ub", "S/cm2",
 "gion_K_cluster_ub", "S/cm2",
 "Xtau_K_cluster_ub", "ms",
 0,0
};
 static double X0 = 0;
 ...
 "usetable_K_cluster_ub", &usetable_K_cluster_ub,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 4);
 	...
 	ivoc_help("help ?1 K_cluster_ub C:/Users/kocsis.barnabas/Desktop/modelling/Neuron_software/ping-pong modell/K_cluster_ub.mod\n");
...
static int _reset;
static char *modelname = "Channel: K_cluster_ub";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_X , _lA_alpha_X , _lB_alpha_X , _lVhalf_alpha_X , _lA_beta_X , _lB_beta_X , _lVhalf_beta_X , _lC_alpha_X ;
  _ltemp_adj_X = 5.0 ;
   _lA_alpha_X = 100.0 ;
   _lC_alpha_X = 10.0 ;
   _lVhalf_alpha_X = - 0.038 ;
