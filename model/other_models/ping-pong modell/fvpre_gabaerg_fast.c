...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 4);
 	...
 	ivoc_help("help ?1 fvpre C:/Users/kocsis.barnabas/Desktop/modelling/Neuron_software/ping-pong modell/fvpre_gabaerg_fast.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 39 in file fvpre_gabaerg_fast.mod:\n  SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
