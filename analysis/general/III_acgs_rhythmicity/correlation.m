function [normLrCor,sumacr,lag] = correlation(timeseries1,timeseries2,acgColour,maxlag,binsize,normMethod)
%CORRELATION Cross- or autocorrelation of timeseries.
%   [NORMLRCOR,SUMACR,LAG] = CORRELATION(TIMESERIES1,TIMESERIES2,ACGCOLOUR,
